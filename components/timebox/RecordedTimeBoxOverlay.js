...
export default function RecordedTimeBoxOverlay(props) {
    ...
    return <>{recordedBoxes.map((recordedBoxes, index) => (
        ...
        <div key={index} data-bs-toggle='modal' data-bs-target={"#updateTimeBoxModal"+recordedBoxes.timeBox.id } className="recordedTimeBox" style={{width: overlayDimensions[0]+"px", 
